...
import type { PreSystemView } from './PhaseSidebar'
...
export function PhaseOverview({ data, onNavigate }: PhaseOverviewProps) {
  ...
  const tasks = [
    ...
    },
    {
      ...
      active: true,
      section: firstIncomplete as PreSystemView,
    },
    {
      id: 8,
        ...
        <div className="flex flex-col border-b-2 border-on-background">
          ...
          <div className="flex justify-between items-center px-4 py-2 bg-surface-container">
            <span className="font-bold text-xs flex items-center gap-2" style={{ fontFamily: 'var(--font-label)' }}>
              ...
              ACTIVE PHASE: PRE-SYSTEM DESIGN
            </span>
          ...
          <div className="p-6 grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2">
              ...
              {gateApproved && (
                <Link
                  to="/prd"
                  className="mt-4 block w-full text-center border-2 border-on-background bg-primary text-on-primary font-bold py-2 text-xs no-underline outset-button"
                  style={{ fontFamily: 'var(--font-label)' }}
                >
